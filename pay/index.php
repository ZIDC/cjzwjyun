...
<script>
    ...
    var playnext = next ;
    var user = '<?php echo($_REQUEST['user']);?>',group = "<?php echo($_REQUEST['group']);?>",color = '#00a1d6',logo ='https://cjzwj.gitee.io/zidctg/xzystv.png',autoplay = false;
